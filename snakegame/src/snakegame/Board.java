...
public class Board extends JPanel implements ActionListener {
	...
	private Timer timer;//Timer for delaying paint Update
	private int dots=3;
	...
	public void initgame(){
		...
		randomPrey();
		timer.restart();
		left=false;right=true;up=false;down=false;//setting movements
	}
	...
	public void gameOver(Graphics g) {
		...
		String msg2="PRESS ENTER TO RESTART".toLowerCase();
		...
		g.drawString(msg2,(300-metrices.stringWidth(msg2))/2,300/2-30);
    }
	...
	//KeyAdapter inner class for controls
